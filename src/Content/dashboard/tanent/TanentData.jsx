		...
		<>
			<Tanent>
				<div className="grid  grid-cols-12 inter bg-white">
					<TanentDashBorad />
					<div className="w-full col-span-10 px-3 py-5 border-l-2 border-gray-500 ">
						<div className="px-4">
							<h1 className="font-bold text-sm lg:text-[16px]  text-[#3A3A3A] ">
								Profile Details
							</h1>
							<p className="text-justify text-xs text-[#545454]">
								Manage and organize groups effortlessly. Create, Join or
								moderate positions based on your preferences and objectives.
							</p>
						</div>
						<div className="my-8 rounded-lg shadow-xl shadow-gray-400 bg-white">
							...
							<div className=" px-8 py-5  md:px-10 md:py-10">
								<form onSubmit={handleSubmit}>
									<div className="flex justify-center   flex-wrap gap-6 lg:flex-row lg:flex-wrap lg:items-start">
