			...
			<div className="mt-10 lg:px-28 px-5   ">
				<div className="mt-14">
					...
					<p className="text-center lg:text-xl text-lg mt-5 mb-5">
						...
						vision and execution. They clarify user needs, streamline workflows,
						and ensure every interaction is purposeful—empowering teams to
						deliver systems that truly perform.
					</p>
				</div>
			</div>
		</>
